...
| Name | Comment |
| ---  | ---      |
| Tyler Hickman | William Wu: I really liked how you explained how important your leadership job is. I agree with you that the key to collaboration is good leadership, which you demonstrated. 2/2 You demonstrated your knowledge of if else statements in your logic gates. It made your code effective and is perfect for lazy coders. However, it would've been nice if you explained a bit more on how it worked. 1.75/2 I loved how you inputted a gray scale as a subsitutue for gray scale. It's very unique and clever. 2/2 One suggestion I have is to format your logic gate user interface a bit better. I understand why you inputted tables but I believe there is a better approach. In my opionion, the logic gate page is too spread out. I think you can use the space better. Overewall, great job and wonderful video! 5.75/6 <br> <br> Aidan Wu: I think you did a great job explaining how you managed our team well. Your idea to split the logic gates into two groups on the scrumboard was a very good idea to make work more efficient. 2/2 Your for loop also definitely made everything easier, helping us become lazy programmers. Though I think it would have been better if you explained what your for loop did and why more in detail. 1.75/2 Finally, the logic gate code was great, being able to select inputs for a and b, and using tables to format the page wasn't a bad idea either. 2/2 However, I think the visual appeal could have been better. The black font color didn't fit well with the background and makes the text harder to see. A way to fix this would be to change the background for that page specifically, change the font color, or add a highlight/background color for just the table. Overall, very nice job! 5.75/6<br> <br> Arch Huang: Topic 1 (Scrum Board Organization): Clear voice and emphasis on leadership, high enthusiasm when explaining the topic. Gave examples by providing [tickets](https://github.com/Archkitten/python_experts/issues/48) to help enforce the idea of leadership and explained the successes of doing so. 2/2 Topic 2 (Logic Gates): Nice demonstration of knowledge on collegeboard conditional statements, iteration and logic gates. I liked the visual demonstration of the project running on the website, as well as the explanation of code. 2/2 Topic 3 (Grayscale): Greenscale was a very unique addition to the project, the connection to collegeboard iteration was also very nice. The tour of code was simple and straight-forward. 2/2 Overall: 6/6 <br> <br> David Xie: The demonstration of leadership and how you utilized each big idea is good. I also like how you demonstrated your leadership. The code for each big idea looks good as well. A point of improvement would be to make the code a little bigger and easier to see. I found most of the code a little too small and blurry to understand. |
| William Wu | Aidan Wu: I think you showed did a good job showing how the collaboration on the slides had a very good effect on our website, seeing that our website did follow the slides pretty closely. For example, the about pages and the games pages being really similar to the slides. 2/2 I think you also did very well showing the code for shifting left or right, so we know how shifting works. 2/2 The conditionals in the code for Tic Tac Toe definitely showed your understanding of conditionals, for example with long conditionals that was shown for how the website decides when a player wins. I think the layout for Tic Tac Toe was very well thought out. I liked how the Reset button in the page was blue with round edges, making it actually look like something part of a game, which is the whole point of our website. 2/2 One thing you could work on would be that when player X or player O wins, the final X or O is actually displayed on the Tic Tac Toe board. Overall, great job! 6/6 <br> <br> Arch Huang: Topic 1 (Scrum Board Organization): Demonstrating before and after pictures from our idea to our website was a very nice addition. There was a quick tour of code on the about page, as well as the scrum board display helping visualize organization. 2/2 Topic 2 (Binary Math Shift): Started off with a tour of code relating to Binary Math, focusing on shifting left and right. A very good demonstration of what the code does directly on the website. PBL, no college board topic needed. 2/2 Topic 3 (Tic Tac Toe): Coding TicTacToe was a very unique and challenging concept, one we thought about since the start of the trimester. Excellent work! The tour of code and demonstration of the knowledge on the website was great, very fluent in your understanding. I think something you could do next time is directly state the link between this project and collegeboard’s conditional statements unit. 1.75/2 (The lower score is not indicative of your actual performance, I just followed the rubric on myconnect. You did superb on the last topic!) Overall: 5.75/6 <br> <br> Ticket <br> <br> David Xie: The contributions and work you put in are good. You demonstrated each big idea pretty well as well. You demonstrated the minilabs and our website design really well. A point of improvement would be to make the code a bit bigger and less blurry. I found that the code is a bit too small and blurry to read. |
| Arch Huang | William Wu: Very clever how you used conditional variables and a event listen to detect when a key was pressed. 2/2 I found it really unique that you could intereact with the music. Your demonstration was AMAZING. You explained the code very well and I liked how you put text of what keys you were pressing to make your deomonstartion easier to follow. 2/2 Your implementation of lables and checkboxes helps organize all our roles and duties so that we can all collaborate better. 2/2 One suggestion I have is to add some instructions on your blackscreen music game to help the user know what is going on. Overall, amazing job Arch! 6/6 <br> <br> Aidan Wu: I think that you did a great job showing how you resolved the issue you ran into while doing deployment by actually show us the page where you found the solution with the command you needed to fix it "sudo apt-get install libatlas-base-dev". The use of conditionals and booleans in blackscreen to decide what sound would play when a key is pressed showed off your understanding of conditionals and booleans. 1.75/2 I also think that you adding the mario sound track along with its respective key in the game was a very nice addition, making it more game-like. For examples, the key w played the jump sound effect. 2/2 Finally, I think the checkboxes and the labels you added to the scrumboard was very useful, since it allowed us to easily see which tasks we have completed and which ones we still have to work on. 2/2 One thing to work on would be to change the navbar (only on this page) to also incorporate the blackscreen style by changing its white background black and changing the text into white (somewhat like dark mode). I would, however, also stress the relationship between your topics with CB a lot more. Overall, nice job! 5.75/6<br> <br> Ticket <br> <br> David Xie: You demonstrated how each big idea was utilized very well. The music was a unique idea. I also like how you demonstrated how you ran the website with a Raspberry Pi. A point of improvement would be to (not even sure if this improvement is necessary) begin with an introduction of what you're going to demonstrate rather than just go into it directly.|
| David Xie |  William Wu: I really liked how you showed the scrum board and commits. However, they don't relly demonstrate collaboration. The text is also a little hard to read. 1.75/2. Nice job showing the structure of our code. However, it would've been nice explaining what each piece of code did. 1.75/2. Great job on your conditional slide. I can clearly see the effective use of if else statements. I also likes how you showed all your test corrections for boolean 2/2. One suggestion I have for you is to use your knowledge on conditionals to create some games such as dice roll. It would also be nice if you could make the pictures on the slides a bit bigger so it won't be so blurry. Overall, nice job! 5.5/6  <br> <br> Aidan Wu: Firstly, try to change your youtube video to at least 720p, so we can see the pictures. I think it was nice how you showed pictures of the scrumboard and commits onto your slide, so it is clear to us what you're talking about. However, your commit don't show you collaborating. Even though you did, you still need evidence. 1.5/2 I enjoyed how you showed us screenshots of the design code, but it would've been better if you explained what the code did and how it relates to project design. 1.75/2 Showing your quiz corrections definitely showed your understanding of booleans and conditionals. 2/2 One thing you could work on would be to explain the code more for both program design and conditionals and booleans to show us more about your understanding about the technical topics. Overall, 5.25/6 <br> <br> Ticket <br> <br> Ticket |
| Aidan Wu | William Wu: Great job explaining how the binary code worked. You explained very clearly what the purpose of the parsint and fromcharcode is in the code. 2/2 Very clever and effective use of if else statements. You explained how the carry worked in your code and on the website very clearly, demonstarting a clear knowledge of the code. 2/2 Very effective use of iteration that shortens the amount of code written while still achieving the same result. This way, it goes through the l function in the range (0,2,n) without needing to type the same thing over and over again. 2/2 One suggestion I have for you is to implement a nicer looking user interface for the extra credit challenge. Overall, you explained all the code very well. Great job! 6/6 <br> <br> Topic 1 (Binary Math Signed Addition): Pair share journal with CB notes demonstration for binary, good link to Binary Math Signed Addition. The tour of code was also very nice. 2/2 Topic 2 (Binary Math Unsigned Addition): Conditionals and Booleans on college board connects to unsigned addition with multiple rows. Tour of code was clear. 2/2 Topic 3 (Week 8 TPT): Starts off mentioning iteration, although could be a bit more clear to say it came from collegeboard. Excellent understanding on the topic and mention of lazy programming with detailed explanations in your tour of code. Nice work! 1.75/2 (The lower score is not indicative of your actual performance, I just followed the rubric on myconnect. Same as William, excellent demonstration of knowledge on the last example!) Overall: 5.75/6 <br> <br> Ticket <br> <br> David Xie: You demonstrated how each big idea was utilized very well. I also like how you demonstrated the Binary Math minilab. The explanation of how if-else statements contribute to a "lazy programmer" is good as well. A point of improvement would be that the code was a little too small and blurry, so you should make them bigger and easier to read. |
...
| Arch | [Week 5 Hackathon](https://github.com/Archkitten/python_experts/commit/6640abbe54f27f284efb96fc591a0641b3c58bec) | 3/3 |
...
> Requirements
- Scrum Master.
- [x] Continue planning best practice, be prepared for review during class on Wednesday, for points.


- Developers.
- [x] Ensure each person has Prototype and/or TT3 hack coding task.  TT3 Binary Math must be included in project with all "Hack" suggestions.  Duplicating a Hack task for multiple individuals and integrating into their personal page(s), would be wise for someone who is behind on code commits. **Everyone** needs code commits.


- Designer.
- [x] Ensure there is a Design or Research asset for prototyping work.


- Navigator/Tester.
- [x] Build a video showing design and runtime of prototype(s).


- Groomers/Developers.
- [x] Groom Scrum Board before delivery, moving Issues to Review, and including Tangible Assets. Time boxed README entries that point to Issues!
...
| William | [Ideation](https://github.com/Archkitten/python_experts/commit/e69f839b6d888ae3af9c1b752a3764cd7af45f30) + [Binary project](https://github.com/Archkitten/python_experts/commit/bf4a9185f944c1b2b7318909cb3ff3c4a65ce635)
